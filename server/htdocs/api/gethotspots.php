...
$result = mysqli_query($con,"SELECT SSID,MAC,lat,lon,radius,isPublic,meta FROM hotspotlist WHERE lat BETWEEN $latMin AND $latMax AND lon BETWEEN $lonMin and $lonMax"); //todo: add WHERE clause to check lat/lon/radius
